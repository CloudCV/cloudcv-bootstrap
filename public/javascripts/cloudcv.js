/**
 * @author Eugene Khvedchenya / http://computer-vision-talks.com/
 */
...
(function(global) {
    ...
    var BASE_URL = "//" + location.host + '/api/v1/';
        ...
        function analyze_t(baseUrl) {
            ...
            this.dominantColors = function(image, callback) {
                ...
                if (image instanceof Blob) {
                    ...
                    $.get(baseUrl + 'dominantColors?image=' + encodeURIComponent(image), function( response ) {
